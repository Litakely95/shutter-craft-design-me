...
const HeroSection = () => {
  return (
    <section id="home" className="pt-24 pb-20 relative">
      ...
      <div className="absolute inset-0 z-0 bg-gradient-to-r from-mep-blue/90 to-mep-blue-dark/70">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1487958449943-2429e8be8625?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80')] mix-blend-overlay opacity-50 bg-cover bg-center"></div>
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col items-center md:items-start md:w-2/3 text-white">
          <div className="animate-fade-in">
            ...
            <p className="text-xl mb-8 max-w-2xl text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 justify-center md:justify-start">
              <Button className="bg-mep-orange hover:bg-mep-orange-dark text-white px-6 py-6 rounded-md text-lg">
                Our Services
